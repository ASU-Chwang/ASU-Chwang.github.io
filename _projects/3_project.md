...
title_ja: AIを用いた植物顕微鏡画像解析と植物フェノタイピング（MOONSHOT Goal 3）
...
description_ja: 気孔、根、葉、植物成長を対象とした深層学習による植物顕微鏡画像解析および植物フェノタイピングに関する研究。MOONSHOT Goal 3の研究課題の一つ。
...
- Stomatal phenotype measurement
- Root detection and segmentation
- Root length measurement
- Leaf-based growth analysis
- Automated plant phenotyping
- Plant growth monitoring
- Deep learning for plant biology
...
- Edge-aware Deep Learning Framework for Automatic Stomatal Segmentation and Phenotype Measurement for Microscopic Image, CVMI Workshop, 2022.
- Deep Learning-based Automatic Plant Root Detection for the Measurement of Plant Root Using Images from Scanner, IAPB Congress, 2023.
